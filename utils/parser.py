...
def get_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Generate feature distances between all samples",
    )
    parser.add_argument(
        "--finetune_model",
        action="store_true",
    ...
    if args.linear_probing and args.ckpts is None:
        raise ValueError("ckpts shouldnt be None while linear_probing mode")
    if args.linear_probing and args.linear_model is None:
        raise ValueError("linear_model shouldnt be None while linear_probing mode")
    if args.test_tsne_umap and args.ckpts is None:
        raise ValueError("ckpts shouldnt be None while test_tsne_umap mode")
    ...
    if args.test:
        ...
        args.exp_name = (
            "linear_" + args.linear_model + args.linear_probing + "_" + args.exp_name
        )
